...
const categories = [
  {
    name: "Malayalam",
    image: assets.movies.malayalam,
    link: "https://dulquer.com/malayalam-movies/",
  },
  {
    name: "Tamil",
    image: assets.movies.tamil,
    link: "https://dulquer.com/tamil-movies/",
  },
  {
    name: "Telugu",
    image: assets.movies.telugu,
    link: "https://dulquer.com/telugu-movies/",
  },
  {
    name: "Bollywood",
    image: assets.movies.hindi,
    link: "https://dulquer.com/hindi-movies/",
  },
];

export default function CategoryPanel({ onClose }: AboutPanelProps) {
  return (
